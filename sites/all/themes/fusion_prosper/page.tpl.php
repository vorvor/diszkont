  ...
  var $ = jQuery.noConflict();
     ...
     $("a#opener").click(function(event){
      ...
      $('div.views-exposed-widget select').click(function() {
      	     $('.nodesinblock').fadeOut( "999" );
      	     $('.panel-col h2').fadeOut( "999" );
      	     $('#szuresek').fadeOut( "999" );	 // or .remove() if you want to completely remove it;
      	});	
      ...
      //   $.colorbox({width:"1000px", inline:true, href:this});
      // });
	  
	  $( "select#edit-sort-bef-combine" ).insertAfter( $( ".pane-search-form" ) );
	  
	  $( "#szuresek" ).insertAfter( $( ".pane-search-form" ) );
      
      $('.nodesinblock h2').prepend('<img class="theImgcba" src="http://diszkontkereso.hu/sites/default/files/cba_60_px.png" />')
      
      $('#nodesinblock-6 h2').prepend('<img id="theImgtesco" src="http://diszkontkereso.hu/sites/default/files/tesco_mobil.png" />')
      
	  $('#nodesinblock-153 form input.form-submit').val('Megveszem!');
